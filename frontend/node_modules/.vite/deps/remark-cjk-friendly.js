import {
  ...
  splice,
  types
} from "./chunk-KLWPDKJ6.js";
import {
  ok
} from "./chunk-GUXVR4YP.js";
import {
  __publicField
...
// node_modules/micromark-extension-cjk-friendly-util/dist/characterWithNonBmp.js
function isEmoji(uc) {
...
// node_modules/micromark-extension-cjk-friendly-util/dist/categoryUtil.js
...
// node_modules/micromark-extension-cjk-friendly-util/dist/classifyCharacter.js
var constantsEx;
...
// node_modules/micromark-extension-cjk-friendly-util/dist/codeUtil.js
...
// node_modules/mdast-util-to-markdown-cjk-friendly/dist/index.mjs
...
function shouldEncodeAfterSupplementaryText(parent, state) {
  ...
  return (sibling == null ? void 0 : sibling.type) === "text" && (firstCodePoint(sibling.value) ?? 0) > 65535;
}
...
function encodeLastCodePoint(value) {
  ...
  return `${characters.join("")}${encodeCharacterReference((last == null ? void 0 : last.codePointAt(0)) ?? codes.eof)}`;
}
function codePointBeforeLast(value) {
  var _a;
  const characters = [...value];
  characters.pop();
  return ((_a = characters.at(-1)) == null ? void 0 : _a.codePointAt(0)) ?? codes.eof;
}
...
function lastCodePoint(value) {
  var _a;
  return ((_a = [...value].at(-1)) == null ? void 0 : _a.codePointAt(0)) ?? codes.eof;
}
...
// node_modules/micromark-extension-cjk-friendly/dist/ext/attention.js
var attention = {
  name: "attention",
...
// node_modules/micromark-extension-cjk-friendly/dist/index.js
...
//# sourceMappingURL=remark-cjk-friendly.js.map
